...
def infill_spacing_local(bands, window=4):
...
def film_seed_azimuth(film, emul, cx, cy, r0, r1, min_thick, snap, n_scan=180,
                      infill=True, consensus=True, verbose=True):
