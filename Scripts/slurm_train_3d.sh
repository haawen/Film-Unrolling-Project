...
# =============================================================================
# Usage:
#   sbatch Scripts/slurm_train_3d.sh              # Train all 5 folds
#   sbatch Scripts/slurm_train_3d.sh 0            # Train fold 0 only
#   sbatch Scripts/slurm_train_3d.sh 0 --c        # Continue training fold 0
#
