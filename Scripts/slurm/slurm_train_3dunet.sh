...
# =============================================================================
# Usage:
#   sbatch Scripts/slurm/slurm_train_3dunet.sh              # Train fold 0
#   sbatch Scripts/slurm/slurm_train_3dunet.sh 0             # Train fold 0
#   sbatch Scripts/slurm/slurm_train_3dunet.sh 0 --resume    # Resume fold 0
#
