#!/bin/bash
# =============================================================================
# Evaluate the video synthetic presets and generate comparison images.
#
# Uses the GT-matching strip width for the synthetic video presets:
#   143558 / 28 ≈ 5127 pixels per winding.
# =============================================================================

#SBATCH --job-name=eval_video_synth
...
#SBATCH --output=logs/eval_video_synth_%j.out
#SBATCH --error=logs/eval_video_synth_%j.err
...
for cfg in "video_4k:R1n" "video_4k_imperfect:R1n" "video_4k_imperfect:R1S"; do
  PRESET="${cfg%:*}"
  VAR="${cfg#*:}"
  EVAL_DIR="unwrapping/inr/results/R1_full_${PRESET}/${VAR}/eval_synthetic_hires"
  COMPARE_DIR="docs/images/compare_${PRESET}_${VAR}"
