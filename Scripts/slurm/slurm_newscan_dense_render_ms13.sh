...
#
#SBATCH --job-name=nsdense_ms13
#SBATCH --partition=daily
#SBATCH --time=24:00:00
#SBATCH --cpus-per-task=16
#SBATCH --mem=360G
#SBATCH --output=/data/user/li_k1/M_thesis/logs/nsdense_ms13_%j.out
...
python -u -m unwrapping.inr.make_film_video \
    "$OUT/wholeroll.npy" "$OUT/film_dense_ms13.mp4" \
