#!/bin/bash
#SBATCH --job-name=oldframe
#SBATCH --partition=daily
#SBATCH --time=06:00:00
#SBATCH --cpus-per-task=8
#SBATCH --mem=96G
#SBATCH --output=/data/user/li_k1/M_thesis/unwrapping/eval/results/oldframe_%j.out
...
OUT=unwrapping/eval/results/stabilization/oldframe
mkdir -p "$OUT"
...
python -m unwrapping.eval.frame_match \
    ...
    --z-crop 0.1985,0.8431 --pitch 1130.06 \
...
python -m unwrapping.eval.stabilize_affine \
    ...
    --out "$OUT/film_oldframe_affine.mp4"
